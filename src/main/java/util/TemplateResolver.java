...
public class TemplateResolver {
    ...
    public List<String> createRepositoryFiles(List<RepositoryModel> repositoryModels, String targetPackagePath, String entitiesPackagePath) {
        for (RepositoryModel repositoryModel : repositoryModels) {
            ...
            resolveTemplate(velocityContext, "repository-base.vm", repositoryModel.repositoryName() + "RepositoryBase.java");
            resolveTemplate(velocityContext, "repository-impl.vm", repositoryModel.repositoryName() + "RepositoryImpl.java");
        }
